...
class EuCookieComplianceConfigForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $form['eu_cookie_compliance']['eu_countries'] = array(
      '#type' => 'textarea',
      '#title' => $this->t('EU countries'),
      '#default_value' => $config->get('eu_countries'),
      '#description' => $this->t('Specify countries that is in EU. Enter country separated by comma.'),
    );
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    $this->config('eu_cookie_compliance.settings')
      ...
      ->set('eu_countries', $form_state->getValue('eu_countries'))
